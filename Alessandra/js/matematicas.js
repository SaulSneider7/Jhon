const preguntas = [
  {
      ...
      respuestas: ["3.1815", "2.4523", "3.1416", "3.1814"],
      correcta: 2
  },
  {
      pregunta: "¿ Que ángulo es el que mide 0° y 90° ?",
      respuestas: ["ángulo obtuso", "ángulo recto", "ángulo llano", "ángulo agudo"],
      correcta: 4
  },
  {
      pregunta: "¿ Un número es divisible por 2 cuando ?",
      respuestas: ["termina en cifra par y cero", " termina en cifra impar y en cero", " termina en cifra  par y en 1", "termina en cifra impar y en 1"],
      correcta: 1
  }
